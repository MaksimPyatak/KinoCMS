import{_ as oi}from"./_plugin-vue_export-helper-c27b6911.js";import{o as K,c as ht,r as ai,a as c,b as k,d as ci,w as hi,e as Xs,u as Ys,f as Ot,g as Js,h as Sn,t as Nt,F as Cn,p as Qs,i as Zs}from"./index-cfc476de.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const D=new Ge("@firebase/analytics");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sh(){if(di())try{await pi()}catch(t){return D.warn(L.create("indexeddb-unavailable",{errorInfo:t==null?void 0:t.toString()}).message),!1}else return D.warn(L.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function rh(t,e,n,i,s,r,o){var a;const h=Zc(t);h.then(w=>{n[w.measurementId]=w.appId,t.options.measurementId&&w.measurementId!==t.options.measurementId&&D.warn(`The measurement ID in the local Firebase config (${t.options.measurementId}) does not match the measurement ID fetched from the server (${w.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(w=>D.error(w)),e.push(h);const l=sh().then(w=>{if(w)return i.getId()}),[d,y]=await Promise.all([h,l]);Kc(r)||Uc(r,d.measurementId),s("js",new Date);const C=(a=o==null?void 0:o.config)!==null&&a!==void 0?a:{};return C[xc]="firebase",C.update=!0,y!=null&&(C[Pc]=y),s("config",d.measurementId,C),d.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oh{constructor(e){this.app=e}_delete(){return delete dt[this.app.options.appId],Promise.resolve()}}let dt={},ti=[];const ei={};let Se="dataLayer",ah="gtag",ni,Ks,ii=!1;function ch(){const t=[];if(dr()&&t.push("This is a browser extension environment."),pr()||t.push("Cookies are not available."),t.length>0){const e=t.map((i,s)=>`(${s+1}) ${i}`).join(" "),n=L.create("invalid-analytics-context",{errorInfo:e});D.warn(n.message)}}function hh(t,e,n){ch();const i=t.options.appId;if(!i)throw L.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)D.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw L.create("no-api-key");if(dt[i]!=null)throw L.create("already-exists",{id:i});if(!ii){Hc(Se);const{wrappedGtag:r,gtagCore:o}=qc(dt,ti,ei,Se,ah);Ks=r,ni=o,ii=!0}return dt[i]=rh(t,ti,ei,e,ni,Se,n),new oh(t)}function lh(t=Ii()){t=gi(t);const e=Et(t,Kt);return e.isInitialized()?e.getImmediate():uh(t)}function uh(t,e={}){const n=Et(t,Kt);if(n.isInitialized()){const s=n.getImmediate();if($t(e,n.getOptions()))return s;throw L.create("already-initialized")}return n.initialize({options:e})}function fh(t,e,n,i){t=gi(t),ih(Ks,dt[t.app.options.appId],e,n,i).catch(s=>D.error(s))}const si="@firebase/analytics",ri="0.9.5";function dh(){H(new B(Kt,(e,{options:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("installations-internal").getImmediate();return hh(i,s,n)},"PUBLIC")),H(new B("analytics-internal",t,"PRIVATE")),M(si,ri),M(si,ri,"esm2017");function t(e){try{const n=e.getProvider(Kt).getImmediate();return{logEvent:(i,s,r)=>fh(n,i,s,r)}}catch(n){throw L.create("interop-component-reg-failed",{reason:n})}}}dh();const ph={apiKey:"AIzaSyA05P1xTD86r4FSacfzaRiDv7hwqYFaNMo",authDomain:"my-kino-cms.firebaseapp.com",projectId:"my-kino-cms",storageBucket:"my-kino-cms.appspot.com",messagingSenderId:"18464466854",appId:"1:18464466854:web:6bcd7d760dcc68f2be9167",measurementId:"G-R936Q3ST84"},gh=wi(ph);lh(gh);Ga();const mh={},yh={class:"wrapper"},vh=c("nav",{class:"main-header navbar navbar-expand navbar-white navbar-light"},[c("ul",{class:"navbar-nav"},[c("li",{class:"nav-item"},[c("a",{class:"nav-link","data-widget":"pushmenu",href:"#",role:"button"},[c("i",{class:"fas fa-bars"})])]),c("li",{class:"nav-item d-none d-sm-inline-block"},[c("a",{href:"index3.html",class:"nav-link"},"Home")]),c("li",{class:"nav-item d-none d-sm-inline-block"},[c("a",{href:"#",class:"nav-link"},"Contact")]),c("li",{class:"nav-item dropdown"},[c("a",{class:"nav-link dropdown-toggle",href:"#",id:"navbarDropdown2",role:"button","data-toggle":"dropdown","aria-haspopup":"true","aria-expanded":"false"}," Help "),c("div",{class:"dropdown-menu","aria-labelledby":"navbarDropdown2"},[c("a",{class:"dropdown-item",href:"#"},"FAQ"),c("a",{class:"dropdown-item",href:"#"},"Support"),c("div",{class:"dropdown-divider"}),c("a",{class:"dropdown-item",href:"#"},"Contact")])])]),c("form",{class:"form-inline ml-3"},[c("div",{class:"input-group input-group-sm"},[c("input",{class:"form-control form-control-navbar",type:"search",placeholder:"Search","aria-label":"Search"}),c("div",{class:"input-group-append"},[c("button",{class:"btn btn-navbar",type:"submit"},[c("i",{class:"fas fa-search"})])])])]),c("ul",{class:"navbar-nav ml-auto"},[c("li",{class:"nav-item dropdown"},[c("a",{class:"nav-link","data-toggle":"dropdown",href:"#"},[c("i",{class:"far fa-comments"}),c("span",{class:"badge badge-danger navbar-badge"},"3")]),c("div",{class:"dropdown-menu dropdown-menu-lg dropdown-menu-right"},[c("a",{href:"#",class:"dropdown-item"},[c("div",{class:"media"},[c("div",{class:"media-body"},[c("h3",{class:"dropdown-item-title"},[k(" Brad Diesel "),c("span",{class:"float-right text-sm text-danger"},[c("i",{class:"fas fa-star"})])]),c("p",{class:"text-sm"},"Call me whenever you can..."),c("p",{class:"text-sm text-muted"},[c("i",{class:"far fa-clock mr-1"}),k(" 4 Hours Ago")])])])]),c("div",{class:"dropdown-divider"}),c("a",{href:"#",class:"dropdown-item"},[c("div",{class:"media"},[c("div",{class:"media-body"},[c("h3",{class:"dropdown-item-title"},[k(" John Pierce "),c("span",{class:"float-right text-sm text-muted"},[c("i",{class:"fas fa-star"})])]),c("p",{class:"text-sm"},"I got your message bro"),c("p",{class:"text-sm text-muted"},[c("i",{class:"far fa-clock mr-1"}),k(" 4 Hours Ago")])])])]),c("div",{class:"dropdown-divider"}),c("a",{href:"#",class:"dropdown-item"},[c("div",{class:"media"},[c("div",{class:"media-body"},[c("h3",{class:"dropdown-item-title"},[k(" Nora Silvester "),c("span",{class:"float-right text-sm text-warning"},[c("i",{class:"fas fa-star"})])]),c("p",{class:"text-sm"},"The subject goes here"),c("p",{class:"text-sm text-muted"},[c("i",{class:"far fa-clock mr-1"}),k(" 4 Hours Ago")])])])]),c("div",{class:"dropdown-divider"}),c("a",{href:"#",class:"dropdown-item dropdown-footer"},"See All Messages")])]),c("li",{class:"nav-item dropdown"},[c("a",{class:"nav-link","data-toggle":"dropdown",href:"#"},[c("i",{class:"far fa-bell"}),c("span",{class:"badge badge-warning navbar-badge"},"15")]),c("div",{class:"dropdown-menu dropdown-menu-lg dropdown-menu-right"},[c("span",{class:"dropdown-header"},"15 Notifications"),c("div",{class:"dropdown-divider"}),c("a",{href:"#",class:"dropdown-item"},[c("i",{class:"fas fa-envelope mr-2"}),k(" 4 new messages "),c("span",{class:"float-right text-muted text-sm"},"3 mins")]),c("div",{class:"dropdown-divider"}),c("a",{href:"#",class:"dropdown-item"},[c("i",{class:"fas fa-users mr-2"}),k(" 8 friend requests "),c("span",{class:"float-right text-muted text-sm"},"12 hours")]),c("div",{class:"dropdown-divider"}),c("a",{href:"#",class:"dropdown-item"},[c("i",{class:"fas fa-file mr-2"}),k(" 3 new reports "),c("span",{class:"float-right text-muted text-sm"},"2 days")]),c("div",{class:"dropdown-divider"}),c("a",{href:"#",class:"dropdown-item dropdown-footer"},"See All Notifications")])]),c("li",{class:"nav-item"},[c("a",{class:"nav-link","data-widget":"control-sidebar","data-slide":"true",href:"#",role:"button"},[c("i",{class:"fas fa-th-large"})])])])],-1),wh=c("aside",{class:"main-sidebar sidebar-dark-primary elevation-4"},[c("a",{href:"index3.html",class:"brand-link"},[c("span",{class:"brand-text font-weight-light"},"AdminLTE 3")]),c("div",{class:"sidebar"},[c("div",{class:"user-panel mt-3 pb-3 mb-3 d-flex"},[c("div",{class:"image"}),c("div",{class:"info"},[c("a",{href:"#",class:"d-block"},"Alexander Pierce")])]),c("nav",{class:"mt-2"},[c("ul",{class:"nav nav-pills nav-sidebar flex-column","data-widget":"treeview",role:"menu"},[c("li",{class:"nav-item menu-open"},[c("a",{href:"#",class:"nav-link active"},[c("i",{class:"nav-icon fas fa-tachometer-alt"}),c("p",null,[k(" Starter Pages "),c("i",{class:"right fas fa-angle-left"})])]),c("ul",{class:"nav nav-treeview"},[c("li",{class:"nav-item"},[c("a",{href:"#",class:"nav-link active"},[c("i",{class:"far fa-circle nav-icon"}),c("p",null,"Active Page")])]),c("li",{class:"nav-item"},[c("a",{href:"#",class:"nav-link"},[c("i",{class:"far fa-circle nav-icon"}),c("p",null,"Inactive Page")])])])]),c("li",{class:"nav-item"},[c("a",{href:"#",class:"nav-link"},[c("i",{class:"nav-icon fas fa-th"}),c("p",null,[k(" Simple Link "),c("span",{class:"right badge badge-danger"},"New")])])])])])])],-1);function Ih(t,e){return K(),ht("div",yh,[vh,wh,ai(t.$slots,"default")])}const Eh=oi(mh,[["render",Ih]]),bh={__name:"LayoutFrame",setup(t){const e=Eh;return(n,i)=>(K(),ci(Xs(Ys(e)),null,{default:hi(()=>[ai(n.$slots,"default")]),_:3}))}};const Ws=t=>(Qs("data-v-2eb36012"),t=t(),Zs(),t),Th={class:"home-page"},Ah=Ws(()=>c("h1",null," Home page ",-1)),_h=Ws(()=>c("br",null,null,-1)),Sh={__name:"HomePage",setup(t){Ot(""),Ot("");const e=Ot([]),n=Ot([]);return Js(()=>{}),(i,s)=>(K(),ci(bh,null,{default:hi(()=>[c("div",Th,[Ah,(K(!0),ht(Cn,null,Sn(e.value,r=>(K(),ht("p",{key:r.name},[k(" Country: "+Nt(r.name),1),_h,k(" Capital: "+Nt(r.capital),1)]))),128)),(K(!0),ht(Cn,null,Sn(n.value,r=>(K(),ht("p",{key:r.firstName},Nt(r.firstName)+" "+Nt(r.lastName),1))),128))])]),_:1}))}},kh=oi(Sh,[["__scopeId","data-v-2eb36012"]]);export{kh as default};
